...
def run_fill_timecards():
    ...
    try:
        ...
        configured_timesheets: list[TimesheetSetting] = timesheet_setting_crud.get_enabled(session)
        ...
        for configured_timesheet in configured_timesheets:
            if editor.get_service_account_email() != configured_timesheet.service_account_email:
            ...
            try:
                ...
                worksheet = spreadsheet.worksheet(configured_timesheet.worksheet_name)
